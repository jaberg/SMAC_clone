function [Kmm, invKmm, saved_1, saved_2] = gprSRPPprepare(logtheta, covfunc, x, INDEX, y, invKmm);
...
if nargin < 6 %otherwise it is passed as a (cached) parameter.
    invKmm = inv(Kmm);
end
