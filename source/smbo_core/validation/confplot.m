...
%   $Revision: 1.1 $  $Date: 2007/12/07 22:02:37 $
%                        
...
set(a1,'LineStyle','none');     set(a1,'FaceColor',[0.7 0.7 0.7]);
%fh: set(a1,'LineStyle','none');     set(a1,'FaceColor',[0.8 0.8 1]);
...
%fh: commented: set(gca,'Layer','top');               
