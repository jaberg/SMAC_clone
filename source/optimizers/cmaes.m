...
% cmaes.m modifications by TBB: 
% search for the string TBB to find modifications of the origial code
...
%TBB
defopts.tccs = '0.5 % time constant for cumulation for step-size control';
defopts.damps = '0.9 % damping for step size control, usually close to one ';
